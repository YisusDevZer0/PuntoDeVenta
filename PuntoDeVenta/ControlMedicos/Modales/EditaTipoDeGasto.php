...
<div class="form-group">
  ...
  <input type="text" class="form-control " disabled readonly value="<?php echo $Especialistas->Gasto_ID; ?>">
    </div>
    </div>
    
   
    <div class="form-group">
    <label for="exampleFormControlInput1">Nombre del tipo de gasto<span class="text-danger">*</span></label>
     <div class="input-group mb-3">
  
  <input type="text" class="form-control "  id="actnomserv" name="ActNomServ" value="<?php echo $Especialistas->Nom_Gasto; ?>" aria-describedby="basic-addon1" maxlength="60">            
</div></div></div>
...
<script src="js/ActualizacionDeTiposDeGastos.js"></script>
