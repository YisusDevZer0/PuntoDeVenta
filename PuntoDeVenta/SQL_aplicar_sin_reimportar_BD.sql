-- =============================================================================
-- Aplicar SOLO en la base de datos en producción (sin volver a importar el dump).
-- Contenido: tabla GastosPOS_Audita + triggers GastosPOS + triggers PagosServicios.
--
-- CÓMO EJECUTAR
-- • Línea de comandos (recomendado):
--     mysql -u USUARIO -p NOMBRE_BD < SQL_aplicar_sin_reimportar_BD.sql
--
-- • phpMyAdmin: pestaña SQL → abajo del cuadro suele haber un campo "Delimitador"
--   o "Delimiter"; pon $$ y pega TODO este archivo. Si no hay delimitador, usa la
--   consola mysql o HeidiSQL / DBeaver.
--
-- NOTA: Tras esto, Valor_Total_Caja puede haber quedado alto en el pasado (se sumaba
-- el costo de servicios). Revisa cajas abiertas y arqueo; ajusta manual si aplica.
-- =============================================================================
