...
<script src="js/ControlDeTiposDeProductos.js"></script>
   ...
   $(document).ready(function() {
    ...
    $(document).on("click", ".btn-edita", function() {
      console.log("Botón de cancelar clickeado para el ID:", id);
        var id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/EditaTipoProductos.php", { id: id }, function(data) {
            $("#FormCajas").html(data);
    ...
    $(document).on("click", ".btn-elimina", function() {
        var id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/EliminaTipoProductos.php", { id: id }, function(data) {
            $("#FormCajas").html(data);
