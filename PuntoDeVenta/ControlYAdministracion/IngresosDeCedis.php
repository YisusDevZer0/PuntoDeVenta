...
<head>
    <meta charset="utf-8">
    <title>Ingresos de cedis <?php echo $row['Licencia']?></title>
...
<body>
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4" style="color:#0172b6;">Ingresos de cedis de <?php echo $row['Licencia']?> </h6>
            <div class="text-center">
            
<div id="Cajas"></div>
            </div></div></div></div>
            </div>
            <script src="js/IngresosRealizadosEnCedis.js"></script>
