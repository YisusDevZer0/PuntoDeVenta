...
<head>
    <meta charset="utf-8">
    <title>Reporte de Ventas - <?php echo $row['Licencia']?></title>
   ...
   <div id="loading-overlay" class="loading-overlay">
     <div>
       ...
       <div id="loading-text" class="loading-text">Cargando reporte...</div>
     </div>
   </div>
...
<body>
    ...
    <div class="content">
        ...
        <!-- Reporte de Ventas Start -->
        <div class="container-fluid pt-4 px-4">
            <div class="col-12">
                <!-- Header del Reporte -->
                <div class="report-card">
                    <h1 class="page-title">Reporte de Ventas</h1>
                    <p class="page-subtitle">Análisis detallado de ventas - <?php echo $row['Licencia']?></p>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="stats-card text-center">
                            ...
                            <div class="stats-number" id="total-ingresos">$0</div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card text-center">
                            ...
                            <div class="stats-number" id="total-sucursales">0</div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card text-center">
                            ...
                            <div class="stats-number" id="promedio-venta">$0</div>
                ...
                <div class="filter-section">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-filter" data-toggle="modal" data-target="#FiltroPorVendedor">
                                <i class="fas fa-user-tie"></i> Filtrar por Vendedor
                            </button>
                            <button type="button" class="btn btn-filter" onclick="cargarReporteCompleto()">
