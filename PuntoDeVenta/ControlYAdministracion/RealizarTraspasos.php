...
¡Debes elegir una forma de pago!
    ...
    <label for="clienteSelect" style="font-size: 0.75rem !important;">Sucursal</label>
    <div class="input-group mb-3">
...
$('#codigoEscaneado').autocomplete({
  ...
  function agregarArticulo(articulo) {
    ...
    if (row && row.length) {
        ...
        tr += '<td class="TipoMovimiento"><input  type="text" class="form-control " name="TipoMovimiento[]" readonly value=""></td>';
        ...
        tr += '<td " class="Fecha"><input type="date" class="form-control " name="FechaDeTraspaso[]" id="fecha-apertura2-' + articulo.id + '" readonly value=""></td>';
