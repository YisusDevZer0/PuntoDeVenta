          ...
          <div class="col-12">
            <div class="bg-light rounded p-4">
              ...
              <form id="NewTypeUser">
                ...
                <div class="mb-3">
                  <label for="tipouser" class="form-label">Nombre de la marca</label>
                  <input type="text" class="form-control" name="NomMarca" id="nombreservicio" placeholder="Ingrese el nombre del servicio">
                </div>
                
                <div class="mb-3">
                  <label for="tipouser" class="form-label">Correo</label>
                  <input type="text" class="form-control" name="Correo" id="correo" placeholder="Ingrese el nombre del servicio">
                </div>
                <div class="mb-3">
                  <label for="tipouser" class="form-label">Telefono</label>
                  <input type="text" class="form-control" name="Telefono" id="telefono" placeholder="Ingrese el nombre del servicio">
                </div>
                <div class="mb-3">
                  <label for="tipouser" class="form-label">Clave o identificador de proveedor</label>
                  <input type="text" class="form-control" name="Clave" id="clave" placeholder="Ingrese el nombre del servicio">
                </div>
