        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTransferirLoteLabel">
                    <i class="fa-solid fa-truck me-2"></i>Transferir Lote
                </h5>
            ...
            <div class="modal-body">
                <form id="formTransferirLote">
                    ...
                    <div class="alert alert-info">
                        <h6><i class="fa-solid fa-info-circle me-2"></i>Lote Origen</h6>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="guardarTransferencia()">
                    <i class="fa-solid fa-truck me-1"></i>Transferir Lote
                </button>
            </div>
        </div>
    </div>
