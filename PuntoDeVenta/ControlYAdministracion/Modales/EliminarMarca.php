...
$user_id=null;
$sql1= "SELECT * FROM Marcas_POS WHERE Licencia='".$row['Licencia']."' AND Servicio_ID = ".$_POST["id"];
...
<i class="fas fa-question-circle fa-5x text-warning"></i>
        <p>¿Está seguro de que desea eliminar el servicio <?php echo $Especialistas->Nom_Marca; ?> ?</p>
...
<script src="js/EliminarMarcass.js"></script>
