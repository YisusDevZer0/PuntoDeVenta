...
// CONSULTA: Obtener la información completa del corte incluyendo gastos, abonos y encargos
...
// Procesar gastos (viene como JSON con desglose_total)
if (!empty($datosCorte->Gastos)) {
    ...
    if (is_array($gastosData)) {
        ...
        // Formato antiguo - procesar como string
