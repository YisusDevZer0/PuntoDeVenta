...
<?php
  ...
  ?>
      <div class="modal fade bd-example-modal-xl" id="GeneradorDeOrdenesDeTraspasoSucursales" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
 ...
 <form  method="POST" action="' . BASE_URL . 'ControlYAdministracion/GeneradorTraspasosSucursales">
