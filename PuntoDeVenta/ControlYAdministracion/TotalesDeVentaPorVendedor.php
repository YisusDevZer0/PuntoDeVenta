...
<head>
    <meta charset="utf-8">
    <title>Reporte de Ventas por Vendedor - <?php echo $row['Licencia']?></title>
...
<body>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte de Ventas por Vendedor - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-info">
                                ...
                                <div class="stats-number" id="totalTransacciones">0</div>
    ...
    include "Footer.php";?>
    <script src="js/ReporteVentasPorVendedor.js"></script>
</body>
</html>