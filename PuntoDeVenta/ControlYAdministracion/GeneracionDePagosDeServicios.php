    ...
    <script>
        $(document).ready(function() {
            $(document).on("click", ".btn-editcaja", function() {
                ...
                if (id && id != '0') {
                    $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/RegistrarPagoDeServicio.php", {
                        id: id
                    }, function(data) {
                        $("#FormCajas").html(data);
            ...
            $(document).on("click", ".btn-registraGasto", function() {
                var id = $(this).data("id");
                $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/RegistrarEncargo.php", {
                    id: id
                }, function(data) {
                    $("#FormCajas").html(data);
