// Sistema de Gestión de Pedidos - JavaScript Moderno (Versión Corregida)
class SistemaPedidos {
    ...
    // Función para descargar Excel general (CORREGIDA)
    async descargarExcel() {
        try {
            ...
            // Crear formulario para enviar datos con cookies de sesión
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'api/exportar_pedidos_excel.php';
            form.target = '_blank'; // Abrir en nueva ventana para descarga
            form.style.display = 'none';
            
            // Agregar campos de filtros
            ...
            this.mostrarError('Error al generar el archivo Excel: ' + error.message);
        } finally {
            // Restaurar botón
            const btnDescargar = $('#btnDescargarExcel');
    ...
    // Función para descargar Excel de un pedido específico (CORREGIDA)
    async descargarExcelPedido(pedidoId) {
        try {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'api/exportar_pedido_excel.php';
            form.target = '_blank'; // Abrir en nueva ventana para descarga
            form.style.display = 'none';
            
            // Agregar campo de pedido_id
            const input = document.createElement('input');
            input.type = 'hidden';
            ...
            this.mostrarError('Error al generar el archivo Excel del pedido: ' + error.message);
        } finally {
            // Restaurar botón
            const btnDescargar = $(`.descargar-excel-pedido[data-pedido-id="${pedidoId}"]`);
