$('document').ready(function ($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: "https://doctorpez.mx/PuntoDeVenta/ControlYAdministracion/Controladores/ActualizaMinMax.php",
            ...
            success: function (dataResult) {
                ...
                if (dataResult.statusCode == 200) {
                    ...
                    }, 3000); // Mostrar el modal durante 5 segundos antes de recargar la página
