...
<head>
    <meta charset="utf-8">
    <title>Reporte de Rendimiento por Sucursal - <?php echo $row['Licencia']?></title>
...
<body>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte de Rendimiento por Sucursal - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        <div class="col-md-3">
                            <div class="stats-card-primary">
                                ...
                                <div class="stats-label">Sucursales Analizadas</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-info">
                                ...
                                <div class="stats-number" id="sucursalMejor">-</div>
                                <div class="stats-label">Mejor Sucursal</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-warning">
                                ...
                                <div class="stats-number" id="promedioSucursal">$0</div>
                                <div class="stats-label">Promedio por Sucursal</div>
                            </div>
                        </div>
                    </div>
    ...
    include "Footer.php";?>
    <script src="js/ReporteSucursales.js"></script>
</body>
</html> 