...
<head>
    <meta charset="utf-8">
    <title>Reporte de Pagos de Servicios - <?php echo $row['Licencia']?></title>
...
<body>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte de Pagos de Servicios - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        <div class="col-md-3">
                            <div class="stats-card-primary">
                                ...
                                <div class="stats-number" id="totalPagos">0</div>
                                <div class="stats-label">Total de Pagos</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-success">
                                ...
                                <div class="stats-number" id="totalCosto">$0</div>
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-warning">
                                ...
                                <div class="stats-number" id="promedioPago">$0</div>
                                <div class="stats-label">Promedio por Pago</div>
                            </div>
                        </div>
                    </div>
    ...
    include "Footer.php";?>
    <script src="js/ReportePagosDeServicios.js"></script>
</body>
</html>
