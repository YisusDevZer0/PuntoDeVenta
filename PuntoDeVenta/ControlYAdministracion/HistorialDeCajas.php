...
<body>
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">Cajas actualmente activas  <?php echo $row['Licencia']?> Sucursal <?php echo $row['Nombre_Sucursal']?></h6>
...
<div id="CajasHistorial"></div>
    ...
    $(".btn-editcaja").click(function(){
        id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/AbreCaja.php", "id=" + id, function(data){
            $("#form-edit").html(data);
   ...
   $(document).ready(function() {
    ...
    $(document).on("click", ".btn-desactiva", function() {
      console.log("Botón de cancelar clickeado para el ID:", id);
        var id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/DesactivaCaja.php", { id: id }, function(data) {
            $("#FormCajas").html(data);
    ...
    $(document).on("click", ".btn-reactiva", function() {
        var id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/ReactivaCaja.php", { id: id }, function(data) {
            $("#FormCajas").html(data);
    ...
    $(document).on("click", ".btn-registraGasto", function() {
        var id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>ControlYAdministracion/Modales/RegistrarGasto.php", { id: id }, function(data) {
            $("#FormCajas").html(data);
