...
function actualizarSumaTotal() {
  ...
  if (metodoPago === "Credito") {
    ...
    botonVenta.disabled = false; // Activar el botón de venta automáticamente si es "Crédito"
  } else {
  ...
  // Validar si el total de la venta ha sido cubierto para habilitar el botón
  var totalCubierto = iptEfectivo + iptTarjeta; // Suma de pagos
  botonVenta.disabled = totalCubierto < totalVenta; // Habilitar si total cubierto es suficiente
}
