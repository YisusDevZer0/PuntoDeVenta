...
<head>
    <meta charset="utf-8">
    <title>Reporte de Productos Más Vendidos - <?php echo $row['Licencia']?></title>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte de Productos Más Vendidos - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <label for="limite" class="form-label">
                                <i class="fas fa-sort-numeric-up me-1"></i> Top Productos
                            </label>
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        <div class="col-md-3">
                            <div class="stats-card-primary">
                                ...
                                <div class="stats-label">Productos Analizados</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-info">
                                ...
                                <div class="stats-number" id="productoEstrella">-</div>
                                <div class="stats-label">Producto Estrella</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-warning">
                                ...
                                <div class="stats-number" id="porcentajeTop10">0%</div>
                                <div class="stats-label">% Top 10</div>
                            </div>
                        </div>
                    </div>
