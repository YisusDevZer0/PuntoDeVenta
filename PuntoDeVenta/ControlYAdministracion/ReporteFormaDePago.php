...
<head>
    <meta charset="utf-8">
    <title>Reporte por Forma de Pago - <?php echo $row['Licencia']?></title>
...
<body>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte por Forma de Pago - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        <div class="col-md-3">
                            <div class="stats-card-primary">
                                ...
                                <div class="stats-number" id="totalFormasPago">0</div>
                                <div class="stats-label">Formas de Pago</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-info">
                                ...
                                <div class="stats-number" id="formaMasUsada">-</div>
                                <div class="stats-label">Forma Más Usada</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-warning">
                                ...
                                <div class="stats-number" id="porcentajeEfectivo">0%</div>
                                <div class="stats-label">% Efectivo</div>
                            </div>
                        </div>
                    </div>
    ...
    include "Footer.php";?>
    <script src="js/ReporteFormaDePago.js"></script>
</body>
</html> 