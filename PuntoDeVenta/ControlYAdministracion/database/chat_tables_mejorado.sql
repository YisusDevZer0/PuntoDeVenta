-- =============================================
-- SISTEMA DE CHAT MEJORADO - BASE DE DATOS
-- Versión: 2.0
-- Fecha: 2024
-- =============================================
...
CREATE TABLE IF NOT EXISTS `chat_conversaciones` (
  ...
  CONSTRAINT `fk_chat_conversaciones_sucursal` FOREIGN KEY (`sucursal_id`) REFERENCES `Sucursales` (`ID_Sucursal`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_conversaciones_usuario` FOREIGN KEY (`creado_por`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `chat_participantes` (
  ...
  CONSTRAINT `fk_chat_participantes_conversacion` FOREIGN KEY (`conversacion_id`) REFERENCES `chat_conversaciones` (`id_conversacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_participantes_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `chat_mensajes` (
  ...
  CONSTRAINT `fk_chat_mensajes_conversacion` FOREIGN KEY (`conversacion_id`) REFERENCES `chat_conversaciones` (`id_conversacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_mensajes_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_mensajes_respuesta` FOREIGN KEY (`mensaje_respuesta_id`) REFERENCES `chat_mensajes` (`id_mensaje`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_mensajes_eliminado_por` FOREIGN KEY (`eliminado_por`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `chat_lecturas` (
  ...
  CONSTRAINT `fk_chat_lecturas_mensaje` FOREIGN KEY (`mensaje_id`) REFERENCES `chat_mensajes` (`id_mensaje`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_lecturas_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `chat_reacciones` (
  ...
  CONSTRAINT `fk_chat_reacciones_mensaje` FOREIGN KEY (`mensaje_id`) REFERENCES `chat_mensajes` (`id_mensaje`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_chat_reacciones_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `chat_configuraciones` (
  ...
  CONSTRAINT `fk_chat_configuraciones_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `Usuarios_PV` (`Id_PvUser`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT IGNORE INTO `chat_conversaciones` (`id_conversacion`, `nombre_conversacion`, `descripcion`, `tipo_conversacion`, `creado_por`, `privado`) 
...
CREATE OR REPLACE VIEW `v_chat_conversaciones_info` AS
SELECT 
    c.id_conversacion,
...
CREATE OR REPLACE VIEW `v_chat_mensajes_info` AS
SELECT 
    m.id_mensaje,
    m.conversacion_id,
    m.usuario_id,
...
CREATE OR REPLACE VIEW `v_chat_participantes_info` AS
SELECT 
    p.id_participante,
    p.conversacion_id,
    p.usuario_id,
...
-- Evento para limpiar mensajes antiguos automáticamente (cada 30 días)
-- Descomentar si se desea activar la limpieza automática
/*
CREATE EVENT IF NOT EXISTS `ev_chat_limpiar_mensajes`
ON SCHEDULE EVERY 30 DAY
STARTS CURRENT_TIMESTAMP
DO
  CALL sp_chat_limpiar_mensajes_antiguos(365); -- Eliminar mensajes de más de 1 año
*/
...
SELECT 
    'Instalación del sistema de chat completada' as mensaje,
