...
<head>
    <meta charset="utf-8">
    <title>Reporte Anual de Ventas - <?php echo $row['Licencia']?></title>
...
<body>
            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="color:#0172b6;">
                        ...
                        Reporte Anual de Ventas - <?php echo $row['Licencia']?>
                    </h6>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <label for="tipo_periodo" class="form-label">
                                <i class="fas fa-chart-line me-1"></i> Tipo de Período
                            </label>
                            <select id="tipo_periodo" class="form-control">
                    ...
                    <div class="row mb-4" id="statsRow" style="display: none;">
                        ...
                        <div class="col-md-3">
                            <div class="stats-card-success">
                                ...
                                <div class="stats-label">Total Ventas Anual</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-info">
                                ...
                                <div class="stats-number" id="promedioPeriodo">$0</div>
                                <div class="stats-label">Promedio por Período</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stats-card-warning">
                                ...
                                <div class="stats-number" id="mejorPeriodo">$0</div>
                                <div class="stats-label">Mejor Período</div>
                            </div>
                        </div>
                    </div>
    ...
    include "Footer.php";?>
    <script src="js/ReportesAnuales.js"></script>
</body>
</html> 