...
// Verificar el valor del código escaneado
if (empty($codigo)) {
...
if ($result->num_rows > 0) {
    ...
    var_dump($row); // Verificar el contenido de la fila obtenida
    ...
    echo json_encode(["error" => "No se encontraron artículos para el código proporcionado"]);
}
?>
