<?php
    ...
    $NomMarca = mysqli_real_escape_string($conn, $_POST['NomMarca']);
    ...
    $sql = "SELECT Nom_Marca, Licencia, Agregadoel FROM Marcas_POS WHERE Nom_Marca='$NomMarca' AND Licencia='$Licencia'";
    ...
    if(mysqli_num_rows($resultset) > 0) {
        ...
        $sql = "INSERT INTO `Marcas_POS`(`Nom_Marca`, `Agregado_Por`, `Agregadoel`, `Sistema`, `Licencia`) 
                VALUES ('$NomMarca', '$AgregadoPor', '$AgregadoEl', '$Sistema', '$Licencia')";
