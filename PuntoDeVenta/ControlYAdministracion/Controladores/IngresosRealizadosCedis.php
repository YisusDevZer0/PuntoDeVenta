...
tabla = $('#Clientes').DataTable({
 ...
 "bAutoWidth": false,
 "order": [[ 0, "desc" ]],
 "sAjaxSource": "https://doctorpez.mx/PuntoDeVenta/ControlYAdministracion/Controladores/ArrayIngresosCedis.php",
 "aoColumns": [
// Correspondencia de mData con campos de la consulta
{ mData: 'IdProdCedis' },       // ID de ingreso => $fila["IDIngreso"]
{ mData: 'NumFactura' },        // Número de factura => $fila["NumFactura"]
{ mData: 'Cod_Barra' },         // Código de barra => $fila["Cod_Barra"]
{ mData: 'Nombre_Prod' },       // Nombre del producto => $fila["Nombre_Prod"]
{ mData: 'Piezas' },            // Cantidad de piezas => $fila["Piezas"] (deberás incluir en la consulta)
{ mData: 'Fecha_Caducidad' },   // Fecha de caducidad => $fila["Fecha_Caducidad"]
{ mData: 'Lote' },              // Lote => $fila["Lote"]
{ mData: 'AgregadoPor' },       // Usuario que agregó => $fila["AgregadoPor"]
{ mData: 'AgregadoEl' },        // Fecha en que se agregó => $fila["AgregadoEl"]
...
<th>Fecha de caducidad</th>     <!-- Fecha de caducidad -->
<th>Lote</th>                   <!-- Lote -->
