...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditarLabel" aria-hidden="true">
    <!-- Contenido del modal para Edición -->
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <!-- Botón para guardar cambios si es necesario -->
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modalHistorial" tabindex="-1" role="dialog" aria-labelledby="modalHistorialLabel" aria-hidden="true">
    <!-- Contenido del modal para Historial -->
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <!-- Aquí puedes mostrar el historial del producto -->
...
<script>
    ...
    function cargarModalEditar(id) {
        ...
        $('#modalEditar').modal('show'); // Activar el modal de edición al hacer clic en el botón correspondiente
    }

    // Función para cargar el ID del producto en el modal de Historial
    function cargarModalHistorial(id) {
        $('#modalHistorialId').text(id);
        // Aquí puedes añadir lógica adicional para cargar el historial del producto en el modal si es necesario
        $('#modalHistorial').modal('show'); // Activar el modal de historial al hacer clic en el botón correspondiente
    }
