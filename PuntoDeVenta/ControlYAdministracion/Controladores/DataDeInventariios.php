...
<style>
  ...
  #Clientes th {
    ...
    padding: 4px;
    /* Ajustar el espaciado entre los encabezados */
    white-space: nowrap;
    /* Evitar que los encabezados se dividan en varias líneas */
  }
</style>
...
<style>
  ...
  #Clientes {
    font-size: 12px;
    /* Tamaño de letra para el contenido de la tabla */
  ...
  #Clientes th {
    font-size: 16px;
    /* Tamaño de letra para los encabezados de la tabla */
    background-color: #ef7980 !important;
    /* Nuevo color de fondo para los encabezados */
    color: white;
    /* Cambiar el color del texto a blanco para contrastar */
    padding: 10px;
  ...
  #Clientes td {
    ...
    /* Agregar una línea de separación entre las filas */
    color: #000000;
  }
...
<style>
  ...
  #loading-overlay {
    ...
    align-items: center;
    z-index: 9999;
    /* Asegurarse de que el overlay esté encima de todo */
    display: none;
    /* Ocultar inicialmente el overlay */
  }

  /* Estilo para el ícono de carga */
  .loader {
    border: 6px solid #f3f3f3;
    /* Color del círculo externo */
    border-top: 6px solid #26b814;
...
<script>
  ...
  tabla = $('#Clientes').DataTable({
    ...
    "sAjaxSource": "<?php echo BASE_URL; ?>ControlYAdministracion/Controladores/ArrayReporteInventariosCEDIS.php",
