...
while ($fila = $result->fetch_assoc()) {
    ...
    $data[] = [
        ...
        "Eliminar" => '<td><a data-id="' . $fila["Servicio_ID"] . '" class="btn btn-success btn-sm btn-elimina dropdown-item" style="background-color: #0172b6 !important;" ><i class="fa-solid fa-pen-to-square"></i></a></td>'
    ];
}
