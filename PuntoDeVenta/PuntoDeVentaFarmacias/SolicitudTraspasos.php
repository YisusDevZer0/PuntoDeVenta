...
<style>
        .fish {
            ...
            width: 70%; /* Reducir el tamaño de la imagen al 50% */
        }
...
tr += '<td class="Diferenciaresultante"><input class="form-control cantidad-diferencia-input" style="font-size: 0.75rem !important;" type="number" name="PrecioMaximo[]" /></td>';
