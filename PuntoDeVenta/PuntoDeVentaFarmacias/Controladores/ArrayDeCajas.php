...
while ($fila = $result->fetch_assoc()) {
 ...
 $realizar_corte = '<td><a data-id="' . $fila["ID_Caja"] . '" data-sucursal="' . $fila["Fk_Sucursal"] . '" data-hod="' . $fila["ID_H_O_D"] . '" class="btn btn-warning btn-sm btn-realizaCorte" style="color:white;"><i class="fa-solid fa-scissors"></i></a></td>';
