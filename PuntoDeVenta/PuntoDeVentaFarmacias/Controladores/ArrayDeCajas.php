...
$sql = "SELECT Cajas.ID_Caja, Cajas.Cantidad_Fondo, Cajas.Empleado, 
...
Cajas.Fecha_Apertura, Cajas.Valor_Total_Caja, Cajas.Licencia, Sucursales.ID_Sucursal,
 Sucursales.Nombre_Sucursal FROM Cajas, Sucursales WHERE Cajas.Sucursal = Sucursales.ID_Sucursal AND 
