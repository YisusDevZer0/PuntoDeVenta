...
$sql = "SELECT Cod_Barra, ID_Prod_POS, Nombre_Prod, Precio_Venta, Lote, Clave_adicional, Tipo_Servicio
        FROM Stock_POS
        WHERE (Cod_Barra = ? OR Nombre_Prod LIKE ? OR Clave_adicional = '') AND Cod_Barra IS NOT NULL";
