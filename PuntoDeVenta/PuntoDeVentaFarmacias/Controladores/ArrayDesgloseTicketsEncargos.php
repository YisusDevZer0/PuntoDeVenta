...
while ($fila = $result->fetch_assoc()) {
    $data[] = [
        ...
        "Sucursal" => $fila["nombre_sucursal"],
          "Saldar" => '<td><a data-id="' . $fila["NumTicket"] . '" class="btn btn-primary btn-sm btn-Cobrar dropdown-item" style="background-color: #ef7980 !important; color:white"><i class="fa-solid fa-money-bill-transfer"></i></a></td>'
    ];
}
