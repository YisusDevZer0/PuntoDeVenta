...
<head>
    <meta charset="utf-8">
    <title>Control de Caducados - Farmacias - <?php echo $row['Licencia']?></title>
...
<body>
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4" style="color:#0172b6;">Control de Caducados - Farmacias - <?php echo $row['Licencia']?></h6>
