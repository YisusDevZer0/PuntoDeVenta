...
$fcha = date("Y-m-d");
$user_id=null;
$sql1= "SELECT Venta_POS_ID,Folio_Ticket,Fk_Caja,Fk_sucursal FROM Ventas_POS WHERE Fk_Caja = '".$_POST['id']."'  AND Fk_sucursal ='".$row['Fk_Sucursal']."'  order by  Venta_POS_ID ASC limit 1";
...
while ($r=$query->fetch_object()){
  ...
  $sql2= "SELECT Venta_POS_ID,Folio_Ticket,Fk_Caja,Fk_sucursal FROM Ventas_POS WHERE Fk_Caja = '".$_POST['id']."'  AND Fk_sucursal ='".$row['Fk_Sucursal']."'  order by  Venta_POS_ID DESC limit 1";
  ...
  $sql3= "SELECT Venta_POS_ID,Fk_Caja,Turno,Fecha_venta,Fk_sucursal,AgregadoPor,Turno,COUNT(DISTINCT Folio_Ticket)AS Total_tickets,
...
while ($r=$query->fetch_object()){
  ...
  $sql33= "SELECT Venta_POS_ID,Fk_Caja,Turno,Fecha_venta,Fk_sucursal,AgregadoPor,Turno, COUNT(DISTINCT Folio_Ticket)AS Total_tickets,
...
while ($r=$query->fetch_object()){
  ...
  break;
    ...
    $sql6="SELECT Venta_POS_ID,Fk_Caja,Fk_sucursal,Turno,COUNT( DISTINCT Folio_Ticket) AS Total_tickets,SUM(Importe) AS VentaTotalCredito  FROM Ventas_POS where FormaDePago='Crédito Enfermería'  AND Fk_sucursal ='".$row['Fk_Sucursal']."' 
    AND Fk_Caja = ".$_POST["id"];
    ...
    while ($r=$query->fetch_object()){
      ...
      $sql7="SELECT Venta_POS_ID,Fk_Caja,Fk_sucursal,Turno,COUNT( DISTINCT Folio_Ticket) AS Total_tickets,SUM(Importe) AS VentaTotalCreditoLimpieza  FROM Ventas_POS where FormaDePago='Crédito Limpieza'  AND Fk_sucursal ='".$row['Fk_Sucursal']."' 
     AND Fk_Caja = ".$_POST["id"];
    ...
    while ($r=$query->fetch_object()){
      ...
      $sql11="SELECT Venta_POS_ID,Fk_Caja,Fk_sucursal,Turno,COUNT( DISTINCT Folio_Ticket) AS Total_tickets,SUM(Importe) AS VentaTotalCreditoFarmaceutico FROM Ventas_POS where FormaDePago='Crédito Farmacéutico'  AND Fk_sucursal ='".$row['Fk_Sucursal']."' 
      AND Fk_Caja = ".$_POST["id"];
      ...
      while ($r=$query->fetch_object()){
        ...
        $sql12="SELECT Venta_POS_ID,Fk_Caja,Fk_sucursal,Turno,COUNT( DISTINCT Folio_Ticket) AS Total_tickets,SUM(Importe) AS VentaTotalCreditoMedicos FROM Ventas_POS where FormaDePago='Crédito Médico'  AND Fk_sucursal ='".$row['Fk_Sucursal']."' 
        AND Fk_Caja = ".$_POST["id"];
        ...
        while ($r=$query->fetch_object()){
          ...
          break;
            ...
            $sql14="SELECT Ventas_POS.Identificador_tipo,Ventas_POS.Fk_sucursal,Ventas_POS.Fecha_venta,Ventas_POS.AgregadoPor,Ventas_POS.Fk_Caja,
            ...
            Servicios_POS.Servicio_ID,Servicios_POS.Nom_Serv,SUM(Ventas_POS.Importe) as totaldeservicios FROM
             ...
             AND Ventas_POS.Fk_sucursal=Sucursales.ID_Sucursal  
            ...
            while ($r=$query->fetch_object()){
              ...
              $sql20="SELECT Ventas_POS.Identificador_tipo,Ventas_POS.Fk_sucursal,Ventas_POS.Fecha_venta,
            ...
            while ($r=$query->fetch_object()){
              ...
              $sql21="SELECT Ventas_POS.Identificador_tipo,Ventas_POS.Fk_sucursal,Ventas_POS.Fecha_venta,
              Ventas_POS.AgregadoPor,Ventas_POS.Fk_Caja, Ventas_POS.AgregadoEl,SucursalesCorre.ID_SucursalC,SucursalesCorre.
            ...
            while ($r=$query->fetch_object()){
              ...
              $sql22="SELECT Ventas_POS.Identificador_tipo,Ventas_POS.Fk_sucursal,Ventas_POS.Fecha_venta,
              Ventas_POS.AgregadoPor,Ventas_POS.Fk_Caja, Ventas_POS.AgregadoEl,SucursalesCorre.ID_SucursalC,SucursalesCorre.
