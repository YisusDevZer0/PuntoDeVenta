...
<?php if ($Especialistas) : ?>
    ...
    $(document).ready(function() {
        ...
        $('#servicio_id').on('change', function() {
            ...
            $.ajax({
                url: 'https://doctorpez.mx/PuntoDeVenta/PuntoDeVentaFarmacias/Controladores/ObtenerDatosServicio.php',
                type: 'POST',
        ...
        $('#RegistrarPagoDeServicioForm').on('submit', function(e) {
            ...
            $.ajax({
                url: 'https://doctorpez.mx/PuntoDeVenta/PuntoDeVentaFarmacias/Controladores/RegistrarPagoDeServicioController.php',
                type: 'POST',
                data: formData,
                dataType: 'json',
