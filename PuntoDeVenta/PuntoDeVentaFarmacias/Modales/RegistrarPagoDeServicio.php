...
<?php if ($Especialistas) : ?>
    ...
    $(document).ready(function() {
        ...
        $('#servicio_id').on('change', function() {
            ...
            $.ajax({
                url: '<?php echo BASE_URL; ?>PuntoDeVentaFarmacias/Controladores/ObtenerDatosServicio.php',
                type: 'POST',
        ...
        $('#RegistrarPagoDeServicioForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo BASE_URL; ?>PuntoDeVentaFarmacias/Controladores/RegistrarPagoDeServicioController.php',
                type: 'POST',
                data: formData,
                dataType: 'json',
