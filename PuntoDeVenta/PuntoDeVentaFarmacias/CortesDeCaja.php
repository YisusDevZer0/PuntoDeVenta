...
<head>
    <meta charset="utf-8">
    <title>Cortes de cajas disponibles para  <?php echo $row['Licencia']?></title>
...
<body>
    ...
    <div class="col-12">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">Cortes de cajas <?php echo $row['Licencia']?> Sucursal <?php echo $row['Nombre_Sucursal']?></h6>
