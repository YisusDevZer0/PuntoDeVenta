...
<div id="Cajas"></div>
    ...
    $(".btn-editcaja").click(function(){
        id = $(this).data("id");
        $.post("<?php echo BASE_URL; ?>PuntoDeVentaFarmacias/Modales/AbreCajaV2.php", "id=" + id, function(data){
            $("#form-edit").html(data);
...
$(document).on("click", ".btn-realizaCorte", function() {
    ...
    $.post("<?php echo BASE_URL; ?>PuntoDeVentaFarmacias/Modales/RealizarCorte.php", 
    { 
        id: id, 
