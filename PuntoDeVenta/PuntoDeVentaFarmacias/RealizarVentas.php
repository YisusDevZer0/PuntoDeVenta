...
$('#codigoEscaneado').autocomplete({
  ...
  function agregarArticulo(articulo) {
    ...
    if (row && row.length) {
        ...
        tr += '<td style="visibility:collapse; display:none;" class="Fecha"><input hidden type="text" class="form-control " name="FechaDeVenta[]" readonly value="<?php echo $Fecha_Apertura;?>"></td>';
