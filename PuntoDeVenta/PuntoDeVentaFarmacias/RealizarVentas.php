  ...
  function agregarArticulo(articulo) {
    if (!articulo || !articulo.id) {
      ...
      if (row.length) {
        ...
        tr += '<td  style="visibility:collapse; display:none;" class="NumeroTicket"> <input type="text" class="form-control " id="Folio_Ticket" name="NumeroDeTickeT[]" style="font-size: 0.75rem !important;" value="<?php echo $resultado_en_mayusculas; ?>" readonly></td>';
