...
$('#codigoEscaneado').autocomplete({
  ...
  function agregarArticulo(articulo) {
    ...
    if (row && row.length) {
        ...
        tr += '<td  class="NumeroTicketRifa"><input type="text" class="form-control "  id="Folio_Ticket_folioRifa" name="NumeroDeTickeRifa[]" style="font-size: 0.75rem !important;" value="<?php echo $primeras_tres_letras . $totalmonto; ?>" readonly></td>';
