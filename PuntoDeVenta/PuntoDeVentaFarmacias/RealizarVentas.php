...
$('#codigoEscaneado').autocomplete({
  ...
  function agregarArticulo(articulo) {
    ...
    if (row && row.length) {
        ...
        tr += '<td style="visibility:collapse; display:none;" class="NumeroTicket"><input type="text" class="form-control "  id="Folio_Ticket_folioRifa" name="NumeroDeTickeFolioRifa[]" style="font-size: 0.75rem !important;" value="<?php echo $primeras_tres_letras . $totalmonto; ?>" readonly></td>';
