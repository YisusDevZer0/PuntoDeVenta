...
function actualizarSumaTotal() {
  ...
  // Condición cuando el método de pago es "Efectivo y Tarjeta"
  if (metodoPago === "Efectivo y Tarjeta") {
    // Si se paga con efectivo y tarjeta, mostrar solo el valor de efectivo
