...
$('#codigoEscaneado').autocomplete({
  ...
  function agregarArticulo(articulo) {
    ...
    if (row && row.length) {
        ...
        tr += '<td style="visibility:collapse; display:none;" class="NumeroTicketRifa"><input type="text" class="form-control " hidden id="Folio_Ticket_folioRifa" name="NumeroDeTickeRifa[]" style="font-size: 0.75rem !important;" value="<?php echo $totalmonto; ?>" readonly></td>';
